...
angular.module("template/carousel/carousel.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/carousel/carousel.html",
    ...
    "    <a class=\"\" ng-click=\"prev()\" ng-show=\"slides.length > 1\"><span class=\"icon icon-chevron-left\"></span></a>\n" +
    "    <a class=\"\" ng-click=\"next()\" ng-show=\"slides.length > 1\"><span class=\"icon icon-chevron-right\"></span></a>\n" +
    "</div>\n" +
    "");
}]);
